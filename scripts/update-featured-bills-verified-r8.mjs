...
**反対会派の注意点**：共産・新生の両会派とも、予算案全体への反対であり、給食費負担軽減そのものへの反対ではありません。
...
共産・新生は予算案全体に反対。共産は使用料改定・減免廃止・市民税減税・大型事業等、新生はアジア・アジアパラ予算・使用料値上げ・図書館整備・弥富相生山線等を理由に指摘しています。
...
- **賛成**：自民、名古屋民主、公明、減税日本、陽向、創政、維新、新生
- **反対**：共産
